...
class student
{
    ...
    string roll;
    string grade;
    float Cpp, DAA, Mathematics, ECE, Python, Economics, ISES, ISCP, avg;
public:
    void add();
    void display_all();
    void display_one();
...
void student::modify()
{
    ...
    int edit,edit1, n_Cpp, n_DAA, n_Mathematics, n_ECE, n_Python, n_Economics, n_ISES, n_ISCP,n_avg,found=0;
	cout << "\t\t\t\t\t\t\t\t\t**********"<<endl;
	cout << "\t\t\t\t\t\t\t\t\t*                                                                          *"<<endl;
